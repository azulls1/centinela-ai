# AGENTE NXT-PAIGE - EJECUCIÓN DIRECTA

**INSTRUCCIÓN:** Lee y ejecuta las instrucciones del agente.

## PASO 1: Cargar agente
Lee el archivo `agentes/nxt-paige.md` con la herramienta Read.

## PASO 2: Ejecutar tarea
Tarea: **$ARGUMENTS**

Si no hay tarea específica, ofrece tour guiado del framework NXT.
...
3. Si hubo cambios significativos de codigo, crea checkpoint:
   `python herramientas/context_manager.py checkpoint "paige_$(date +%H%M%S)"`
