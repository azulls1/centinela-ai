# AGENTE NXT-DOCS - EJECUCIÓN DIRECTA

**INSTRUCCIÓN:** Lee y ejecuta las instrucciones del agente.

## PASO 1: Cargar agente
Lee el archivo `agentes/nxt-tech-writer.md` con la herramienta Read.

## PASO 2: Ejecutar tarea
Tarea: **$ARGUMENTS**

Si no hay tarea específica, genera documentación del proyecto actual.
...
3. Si hubo cambios significativos de codigo, crea checkpoint:
   `python herramientas/context_manager.py checkpoint "docs_$(date +%H%M%S)"`
