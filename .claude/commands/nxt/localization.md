# AGENTE NXT-LOCALIZATION - EJECUCIÓN DIRECTA

**INSTRUCCIÓN:** Lee y ejecuta las instrucciones del agente.

## PASO 1: Cargar agente
Lee el archivo `agentes/nxt-localization.md` con la herramienta Read.

## PASO 2: Ejecutar tarea
Tarea: **$ARGUMENTS**

Si no hay tarea específica, analiza el estado de i18n del proyecto.
...
3. Si hubo cambios significativos de codigo, crea checkpoint:
   `python herramientas/context_manager.py checkpoint "localization_$(date +%H%M%S)"`
